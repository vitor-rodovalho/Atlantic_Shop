...
urlpatterns = [
    ...
    path('produtos/', views.lista_produtos, name='lista_produtos'), #localhost:8000/produtos
    path('produtos/categoria/<str:categoria_nome>/', views.lista_produtos, name='lista_produtos_categoria')
]